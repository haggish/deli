        ...
        http
            ...
            .authorizeHttpRequests { auth ->
                auth
                    ...
                    .permitAll()
                    .requestMatchers("/ws/**")
                    .permitAll() // WebSocket handled by GatewayHeaderInterceptor
                    .anyRequest()
                    .authenticated()
...
class GlobalExceptionHandler {
    ...
    fun handleDomain(ex: DeliException): ResponseEntity<ApiResponse<Nothing>> =
        ResponseEntity
            .status(HttpStatus.BAD_REQUEST)
            .body(ApiResponse.error(ApiError(ex::class.simpleName ?: "Error", ex.message ?: "")))

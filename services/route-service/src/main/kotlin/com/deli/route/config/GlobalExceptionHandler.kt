...
class GlobalExceptionHandler {
    ...
    fun handleDomainException(ex: DeliException): ResponseEntity<ApiResponse<Nothing>> {
        val status =
            when (ex) {
                is com.deli.shared.domain.model.CourierNotFoundException,
                is com.deli.shared.domain.model.PackageNotFoundException,
                is com.deli.shared.domain.model.StopNotFoundException,
                is com.deli.shared.domain.model.ShiftNotFoundException,
                -> HttpStatus.NOT_FOUND

                is com.deli.shared.domain.model.StopAlreadyCompletedException,
                is com.deli.shared.domain.model.ShiftNotActiveException,
                is com.deli.shared.domain.model.InvalidDeliveryStateTransitionException,
                -> HttpStatus.CONFLICT
    ...
    fun handleValidation(ex: MethodArgumentNotValidException): ResponseEntity<ApiResponse<Nothing>> {
        ...
        return ResponseEntity
            ...
            .body(ApiResponse.error(ApiError("VALIDATION_ERROR", "Request validation failed", details)))
    }
